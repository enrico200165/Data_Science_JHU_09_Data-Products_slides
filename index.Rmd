...
- Extremely simple application using basic shiny (find it [here](https://enrico200165.shinyapps.io/devdataprodw4/), user doc [here](file:///V:/data/learn/02_JHU_DSci/09_data-products/04_course-project/slidify_prj/appdocumentation.html))  
